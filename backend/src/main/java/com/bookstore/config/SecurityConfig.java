    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/orders/*/return/approve").hasRole("ADMIN")
                .requestMatchers("/api/orders/*/return/reject").hasRole("ADMIN")
                ...
                .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/coupons/all").hasRole("ADMIN")
                .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/coupons/**").hasRole("ADMIN")
                .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/coupons/**").hasRole("ADMIN")
                .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/coupons/**").hasRole("ADMIN")
                .requestMatchers("/api/rewards/vouchers/**").hasRole("ADMIN")
                ...
                .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/newsletter/**").hasRole("ADMIN")
                .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/newsletter/send-bulk").hasRole("ADMIN")
