...
with open(r'E:\TestingProject\chap3_nfr_inspection.txt', 'w', encoding='utf-8') as f:
    for idx in range(354, 377):
        p = doc.paragraphs[idx]
        f.write(f"[P{idx}][{p.style.name}] {p.text}\n")
    
    # check tables between 40 and 55
    for t_idx in range(40, 56):
