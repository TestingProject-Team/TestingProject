...
def render_hinh_2_1():
    ...
    # Save PNG
    p_info = os.path.join(INFO_DIR, "Hinh_2.1_Agile_Scrum_Workflow_YiYi_Book.png")
    p_std = os.path.join(STD_DIR, "Hinh_2.1_Agile_Scrum_Workflow_YiYi_Book.png")
    ...
    svg_info = f'''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}">
        ...
        <text x="{W//2}" y="50" font-family="Arial, sans-serif" font-size="32" font-weight="bold" fill="#0F172A" text-anchor="middle">QUY TRÌNH PHÁT TRIỂN PHẦN MỀM AGILE / SCRUM — YIYI BOOK</text>
        <text x="{W//2}" y="85" font-family="Arial, sans-serif" font-size="18" fill="#475569" text-anchor="middle">Mô hình quản trị Sprint 2 tuần, tích hợp CI/CD tự động hóa và đảm bảo chất lượng liên tục</text>
        <!-- Product Backlog -->
        <rect x="100" y="130" width="850" height="180" rx="12" fill="#F0FDFA" stroke="#14B8A6" stroke-width="2"/>
        <rect x="100" y="130" width="850" height="45" rx="12" fill="#0D9488"/>
        <text x="525" y="158" font-family="Arial, sans-serif" font-size="18" font-weight="bold" fill="#FFFFFF" text-anchor="middle">1. PRODUCT BACKLOG & REQUIREMENTS</text>
        <!-- Sprint Planning -->
        <rect x="1050" y="130" width="850" height="180" rx="12" fill="#EFF6FF" stroke="#3B82F6" stroke-width="2"/>
        <rect x="1050" y="130" width="850" height="45" rx="12" fill="#2563EB"/>
        <text x="1475" y="158" font-family="Arial, sans-serif" font-size="18" font-weight="bold" fill="#FFFFFF" text-anchor="middle">2. SPRINT PLANNING & TASK BREAKDOWN</text>
        <!-- Sprint Execution Container -->
        <rect x="100" y="350" width="1800" height="530" rx="16" fill="#FFFFFF" stroke="#6366F1" stroke-width="3"/>
        <rect x="100" y="350" width="1800" height="50" rx="16" fill="#4F46E5"/>
        <text x="1000" y="382" font-family="Arial, sans-serif" font-size="20" font-weight="bold" fill="#FFFFFF" text-anchor="middle">⚡ SPRINT EXECUTION & CONTINUOUS QUALITY ASSURANCE (2 WEEKS CYCLE)</text>
    </svg>'''
    with open(os.path.join(INFO_DIR, "Hinh_2.1_Agile_Scrum_Workflow_YiYi_Book.svg"), "w", encoding="utf-8") as f:
        f.write(svg_info)
    with open(os.path.join(STD_DIR, "Hinh_2.1_Agile_Scrum_Workflow_YiYi_Book.svg"), "w", encoding="utf-8") as f:
        f.write(svg_info)

    print("Rendered Hinh 2.1 successfully.")
