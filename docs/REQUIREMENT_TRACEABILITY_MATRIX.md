...
| YIYI-39 — Idempotent DB seed data | `DataSeeder.java`, `docker-compose.test.yml`, `application-test.properties`, `docs/DATABASE_SEED_IDEMPOTENCY_YIYI-39.md` | Docker Compose test stack khởi động 2 lần không trùng lặp; test suite 299/299 PASS | PASS |
